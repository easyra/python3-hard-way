...
# Sets a varible named "cars_driven" with the value of the variable "drivers"
cars_driven = drivers
# Sets a variable named "carpool_capacity" with the value of the product of the variable "cars_driven" * "space_in_a_car"
